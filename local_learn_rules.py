#!/usr/bin/env python3
"""
Local Rule Learning Script for Bank Transaction Categorization

This script runs locally, connects to your remote database, learns rules,
and updates the local rules.py file for you to commit and push to GitHub.

Usage:
    python local_learn_rules.py [--dry-run] [--min-frequency 2] [--min-confidence 0.8]
...
def main():
    parser = argparse.ArgumentParser(description="Local rule learning from database transactions")
    ...
    print("🏠 Starting LOCAL rule learning process...")
    ...
    if success:
        ...
        print("      git push")
        print("   3. Pull on server:")
        print("      git pull")
        print("   4. Rules will be active immediately (hot-reload)")
